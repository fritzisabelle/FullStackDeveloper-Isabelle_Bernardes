...
export const JobList = [
    {
        ...
        cover: "../src/assets/imgs/Projects/Motolink/project-cover1.png",
        galleryImgs: [
            "../src/assets/imgs/Projects/Motolink/img1.jpg",
            "../src/assets/imgs/Projects/Motolink/img2.jpg",
            "../src/assets/imgs/Projects/Motolink/img3.jpg",
            "../src/assets/imgs/Projects/Motolink/img1.jpg",
        ],
        description: {
    ...
    },
    {
        ...
        cover: "../src/assets/imgs/imgs/project-cover2.jpg",
        galleryImgs: [
            "../src/assets/imgs/imgs/project-cover1.jpg",
            "../src/assets/imgs/imgs/project-cover1.jpg",
            "../src/assets/imgs/imgs/project-cover1.jpg",
            "../src/assets/imgs/imgs/project-cover1.jpg",
            "../src/assets/imgs/imgs/project-cover1.jpg",
