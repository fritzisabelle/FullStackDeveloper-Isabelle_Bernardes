...
export const JobList = [
    {
        ...
        cover: "../src/assets/Projects/Motolink/project-cover1.png",
        galleryImgs: [
            "../src/assets/Projects/Motolink/img1.jpg",
            "../src/assets/Projects/Motolink/img2.jpg",
            "../src/assets/Projects/Motolink/img3.jpg",
            "../src/assets/Projects/Motolink/img1.jpg",
        ],
        description: {
    ...
    },
    {
        ...
        cover: "../src/assets/imgs/project-cover2.jpg",
        galleryImgs: [
            "../src/assets/imgs/project-cover1.jpg",
            "../src/assets/imgs/project-cover1.jpg",
            "../src/assets/imgs/project-cover1.jpg",
            "../src/assets/imgs/project-cover1.jpg",
            "../src/assets/imgs/project-cover1.jpg",
